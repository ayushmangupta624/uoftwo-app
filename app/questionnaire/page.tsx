...
export default function QuestionnairePage() {
  ...
  const handleHobbyInputChange = (value: string) => {
    ...
    const availableHobbies = VALID_HOBBIES.filter(
      (hobby) => !formData.hobbies.includes(hobby.value),
    );
  ...
  const canProceed = () => {
    switch (currentStep) {
      case 0:
        return testMode || pdfFile !== null;
      case 1:
        return formData.campus !== "";
      case 2:
        return formData.hobbies.length > 0;
      case 3:
        return formData.favoriteBands.length > 0;
      case 4:
        return formData.musicGenres.length > 0;
      case 5:
        return formData.sportsTeams.length > 0;
      case 6:
        return formData.footballPreference !== "";
      case 7:
        return formData.clubs.length > 0;
      case 8:
        return formData.studyPreference !== "";
      case 9:
        return formData.favCampusSpots.length > 0;
      case 10:
        return formData.personalityTraits.length > 0;
      case 11:
        return formData.values.length > 0;
      case 12:
        return formData.goingOutFrequency !== "";
      case 13:
        return formData.idealWeekend !== "";
      case 14:
        return formData.aboutMe !== "";
      case 15:
        return formData.lookingFor !== "";
      case 16:
        return formData.dealBreakers.length > 0;
      default:
        return true;
    }
  };
            ...
            <div className="flex-1 flex flex-col">
              <div className="mb-8">
                ...
                <p className="text-lg text-[#5a3939]/90">
                  First, let's add your class schedule as a PDF so we can find
                  the best matches for your week.
                </p>
              </div>
                ...
                {[
                  {
                    value: "St. George",
                    icon: "🏛️",
                    description: "Downtown Toronto - Main Campus",
                  },
                  {
                    value: "Mississauga",
                    icon: "🌳",
                    description: "UTM - Mississauga Campus",
                  },
                  {
                    value: "Scarborough",
                    icon: "🏞️",
                    description: "UTSC - Scarborough Campus",
                  },
                ].map((campus) => (
                  <button
                    key={campus.value}
                    onClick={() =>
                      setFormData((prev) => ({ ...prev, campus: campus.value }))
                    }
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="relative mb-4">
                <input
                  ...
                  onBlur={() =>
                    setTimeout(() => setShowHobbyDropdown(false), 200)
                  }
                  ...
                  <div className="absolute z-10 w-full mt-2 bg-white border-2 border-[#8B5F5F]/30 rounded-xl shadow-lg max-h-60 overflow-y-auto">
                    ...
                    {filteredHobbies.length > 10 && (
                      <div className="px-4 py-2 text-sm text-[#6B4646]/50 italic">
                        + {filteredHobbies.length - 10} more... Keep typing to
                        filter
                      </div>
                    )}
                  </div>
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {formData.hobbies.map((hobby, idx) => {
                  const hobbyLabel =
                    VALID_HOBBIES.find((h) => h.value === hobby)?.label ||
                    hobby;
                  return (
                    <span
                      key={idx}
              ...
              {formData.hobbies.length === 0 && (
                <p className="text-sm text-[#6B4646]/50 italic">
                  Start typing to search from {VALID_HOBBIES.length} available
                  hobbies
                </p>
              )}
            </div>
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="flex gap-2 mb-4">
                <input
                  ...
                  onKeyPress={(e) =>
                    e.key === "Enter" &&
                    addToArray("favoriteBands", currentInput)
                  }
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="flex gap-2 mb-4">
                <input
                  ...
                  onChange={(e) => setCurrentInput(e.target.value)}
                  onKeyPress={(e) =>
                    e.key === "Enter" && addToArray("sportsTeams", currentInput)
                  }
          ...
          {currentStep === 6 && (
            <div className="flex-1 flex flex-col">
              <div className="mb-6">
                ...
                <p className="text-lg text-[#6B4646]/70">
                  What do you call the game where people kick a ball into a net?
                </p>
              </div>

              <div className="grid gap-4">
                {["Football", "Soccer", "Both!", "Neither"].map((option) => (
                  <button
                    key={option}
                    onClick={() =>
                      setFormData((prev) => ({
                        ...prev,
                        footballPreference: option,
                      }))
                    }
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="flex gap-2 mb-4">
                <input
                  ...
                  onChange={(e) => setCurrentInput(e.target.value)}
                  onKeyPress={(e) =>
                    e.key === "Enter" && addToArray("clubs", currentInput)
                  }
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  onKeyPress={(e) =>
                    e.key === "Enter" &&
                    addToArray("favCampusSpots", currentInput)
                  }
          ...
          {currentStep === 13 && (
            <div className="flex-1 flex flex-col">
              <div className="mb-6">
                ...
                <p className="text-lg text-[#6B4646]/70">Paint us a picture</p>
              </div>
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="flex gap-2 mb-4">
                <input
                  ...
                  onKeyPress={(e) =>
                    e.key === "Enter" &&
                    addToArray("dealBreakers", currentInput)
                  }
              ...
              {formData.dealBreakers.length === 0 && (
                <button
                  onClick={() => {
                    setFormData((prev) => ({
                      ...prev,
                      dealBreakers: ["None in particular"],
                    }));
                  }}
                  className="mt-4 text-[#8B5F5F] hover:text-[#6B4646] font-medium"
                >
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto space-y-4">
                <div className="p-4 bg-[#8B5F5F]/5 rounded-xl">
                  <h3 className="font-semibold text-[#6B4646] mb-2">
                    Schedule
                  </h3>
                ...
                <div className="p-4 bg-[#8B5F5F]/5 rounded-xl">
                  ...
                  <p className="text-sm text-[#6B4646]/70">
